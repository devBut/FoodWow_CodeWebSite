...
<div class="container">
  <div class="info">
    <h1>Administration </h1><span> Đăng nhập tài khoản</span>
  </div>
</div>
<div class="form">
  ...
  <form class="register-form" action="index.php" method="post">
    <input type="text" placeholder="tên tài khoản" name="cr_user"/>
    <input type="text" placeholder="địa chỉ email"  name="cr_email"/>
	 <input type="password" placeholder="mật khẩu"  name="cr_pass"/>
	  <input type="password" placeholder="Xác nhận mật khẩu"  name="cr_cpass"/>
	  <input type="password" placeholder="Unique-Code"  name="code"/>
   <input type="submit"  name="submit1" value="Create" />
    <p class="message">Đã đăng ký? <a href="#">Đăng nhập</a></p>
  </form>
  ...
  <form class="login-form" action="index.php" method="post">
    ...
    <p class="message">Chưa đăng ký? <a href="#">Tạo một tài khoản</a></p>
  </form>
