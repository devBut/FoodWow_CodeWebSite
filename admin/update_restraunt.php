...
<head>
    ...
    <title>Admin - Mẫu bảng điều khiển quản trị viên</title>
    <!-- Bootstrap Core CSS -->
                                        ...
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>Đây là tiêu đề</h5> <span class="mail-desc">Chỉ cần gặp quản trị viên mới của tôi!</span> <span class="time">9:30 AM</span>
                                                </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>Nguyễn Thị Kiều Trang</h5> <span class="mail-desc">Chỉ cần xem quản trị viên của tôi!</span> <span class="time">9:30 AM</span>
                                                </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>Bùi Tấn Thành</h5> <span class="mail-desc">Tôi đã hát một bài hát! Hẹn gặp bạn tại</span> <span class="time">9:10 AM</span>
                                                </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>Nguyễn Quốc Khánh</h5> <span class="mail-desc">Tôi là một ca sĩ!</span> <span class="time">9:08 AM</span>
                                                </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>Nguyễn Thanh Tú</h5> <span class="mail-desc">Chỉ cần xem quản trị viên của tôi!</span> <span class="time">9:02 AM</span>
                                                </div>
                                            </a>
                                        </div>
                                    </li>
                                    <li>
                                        <a class="nav-link text-center" href="javascript:void(0);"> <strong>Xem tất cả e-Mails</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Bảng điều khiển</span></a>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Store</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="allrestraunt.php">Tất cả các cửa hàng</a></li>
								<li><a href="add_category.php">Thêm loại</a></li>
                                <li><a href="add_restraunt.php">Thêm cửa hàng</a></li>
                      ...
                      <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Menu</span></a>
						 ...
						 <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="hide-menu">Orders</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_orders.php">Tất cả các đơn hàng</a></li>
                                ...
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                       <?php $ssql ="select * from restaurant where rs_id='$_GET[res_upd]'";
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="res_name" value="<?php echo $row['title'];  ?>" class="form-control" placeholder="CNTT K14">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" value="<?php echo $row['phone'];  ?>" placeholder="+84 332775431">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
											 ...
											 <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="o_days" class="form-control custom-select"  data-placeholder="Choose a Category" tabindex="1">
                                                        <option>--Chọn ngày mở cửa--</option>
                                        ...
                                        <!--/row-->
                                        <h3 class="box-title m-t-40">Store Địa chỉ</h3>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="dashboard.php" class="btn btn-inverse">Hủy bỏ</a>
                                    </div>
                                </form>
                            </div>
                        </div>
