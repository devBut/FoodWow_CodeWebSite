...
if(isset($_POST['submit']))           //if upload btn is pressed
{
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
								...
								$store = "Res_img/".basename($fnew);                      // đường dẫn để lưu trữ hình ảnh tải lên
									...
									if($fsize>=1000000)
										{
												...
												$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Max Image Size is 1024kb!</strong> Thử hình ảnh khác.
															</div>';
									...
									else
										{
												...
												move_uploaded_file($temp, $store);
													...
													$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Congrass!</strong> New Restaurant Add Successfully.
															</div>';
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="res_name" class="form-control" placeholder="Nguyễn Thanh Tú">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">E-mail Doanh Nghiệp</label>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" placeholder="+84999999">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
