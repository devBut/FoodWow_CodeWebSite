                    ...
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">Tôi muốn ăn...</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder="Tôi muốn ăn..."> </div>
                            </div>
                            <button onclick="location.href='restaurants.html'" type="button" class="btn theme-btn btn-lg">Tìm kiếm food</button>
                        </form>
                    </div>
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Chọn nhà hàng</h4> </div>
                        <!-- end:Step -->
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Giao hàng tận nơi</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
            ...
            <div class="container">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>Chúng tôi đã nhận được thực đơn của bạn từ hơn 345 nhà hàng giao hàng trực tuyến.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Nhận thức ăn của bạn được giao! Và thưởng thức bữa ăn của bạn! Thanh toán trực tuyến khi nhận hàng hoặc giao hàng</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Thanh toán bằng tiền mặt khi nhận hàng</p>
                    </div>
                </div>
            </div>
        </section>
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> Min  10.000 VNĐ</div>
																		<div class="mins"><i class="fa fa-motorcycle"></i> 30 phút</div>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                ...
                                <p>Giờ đây, bạn có thể chế biến đồ ăn ở bất cứ đâu nhờ tính năng Giao đồ ăn miễn phí, dễ sử dụng &amp; Đưa ra ứng dụng.</p>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    ...
                    <div class="col-xs-12 col-sm-2 about color-gray">
                        ...
                        <ul>
                            <li><a href="#">Wow Food - CNTT K14</a> </li>
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        <h5>Các địa điểm nổi tiếng<o/h5>
                        <ul>
